...
{
    public class TestInvoiceCreatorEmpty : IInvoiceCreator
    {
        public IInvoice GetInvoice()
        {
            return new Invoice(new TestAddressFactoryCreator(), new TestCartProductCreator(), new TestInvoiceDataContextEmpty());
        }
        ...
        {
            return new Invoice(invoiceId, accountId, size, total, cartProducts, dateTime, creditCard, billingAddress, shippingAddress, trackingNumber, new TestAddressFactoryCreator(), new TestCartProductCreator(), new TestInvoiceDataContextEmpty());
        }
    }
}
