...
{
    public class TestInvoiceProcessorCreator : IInvoiceProcessorCreator
    {
        public IInvoiceProcessor GetInvoiceCreator()
        {
            return new InvoiceProcessor(new TestAddressFactoryCreator(), new TestCartCreator(), new CreditCardValidator(), new TestInvoiceDataContext(), new TestInvoiceCreator());
        }
        ...
        {
            return new InvoiceProcessor(invoiceId, accountId, size, total, products, creditCard, billingAddress, shippingAddress, new TestAddressFactoryCreator(), new TestCartCreator(), new CreditCardValidator(), new TestInvoiceDataContext(), new TestInvoiceCreator());
        }
    }
}
